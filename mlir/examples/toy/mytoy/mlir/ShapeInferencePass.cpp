...
struct ShapeInferencePass
  ...
  void runOnOperation() override {
    ...
    // inferred or now change happened (fix point).
    while (!opWorklist.empty()) {
      ...
      // Ask the operation to infer it's output shapes.
    ...
    // If the worklist is not empty, this indicates a failure.
    if (!opWorklist.empty()) {
  ...
  /// A utility method that returns if the given operation has all of it's
  /// operands inferred.
